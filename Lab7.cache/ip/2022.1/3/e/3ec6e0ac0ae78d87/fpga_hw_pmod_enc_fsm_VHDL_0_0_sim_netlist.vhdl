...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pmod_enc_fsm_VHDL_v1_0_S00_AXI is
  ...
  attribute XILINX_TRANSFORM_PINMAP of \nextState_reg[0]\ : label is "VCC:GE GND:CLR";
  attribute XILINX_LEGACY_PRIM of \nextState_reg[1]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \nextState_reg[1]\ : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of \nextState_reg[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nextState_reg[1]_i_3\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of \nextState_reg[2]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \nextState_reg[2]\ : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of \nextState_reg[2]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nextState_reg[2]_i_3\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of \nextState_reg[3]\ : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of \nextState_reg[3]\ : label is "VCC:GE GND:CLR";
begin
...
\currentState_reg[3]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\nextState_reg[1]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"06"
    )
        port map (
...
\nextState_reg[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"021D"
    )
        port map (
...
\nextState_reg[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF7"
    )
        port map (
