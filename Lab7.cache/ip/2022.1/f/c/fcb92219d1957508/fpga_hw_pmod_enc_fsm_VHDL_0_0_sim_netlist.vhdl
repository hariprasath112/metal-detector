...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pmod_enc_fsm_VHDL_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_currentState[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \FSM_sequential_currentState[0]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_sequential_currentState[1]_i_2\ : label is "soft_lutpair2";
...
A2_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => A1,
...
BTN1_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => btn,
...
BTN2_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => BTN1,
...
\FSM_sequential_currentState[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => currentState(2),
      I2 => \FSM_sequential_currentState[0]_i_3_n_0\,
      I3 => currentState(3),
      O => \nextState__0\(0)
    );
\FSM_sequential_currentState[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4DF8"
    )
        port map (
...
\FSM_sequential_currentState[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7E20"
    )
        port map (
...
\FSM_sequential_currentState[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => currentState(2),
      I2 => \FSM_sequential_currentState[1]_i_3_n_0\,
      I3 => currentState(3),
      O => \nextState__0\(1)
    );
...
\FSM_sequential_currentState[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8010"
    )
        port map (
...
\FSM_sequential_currentState[2]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
SW1_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => sw,
...
SW2_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => SW1,
