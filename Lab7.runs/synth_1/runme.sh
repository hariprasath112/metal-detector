...
HD_PWD='D:/EECE351/Lab/Lab7/Lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_hw_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_hw_wrapper.tcl
