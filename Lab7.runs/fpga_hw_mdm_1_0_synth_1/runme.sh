...
HD_PWD='D:/EECE351/Lab/Lab7/Lab7.runs/fpga_hw_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_hw_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_hw_mdm_1_0.tcl
