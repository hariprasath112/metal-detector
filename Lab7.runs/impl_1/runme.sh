...
HD_PWD='D:/EECE351/Lab/Lab7/Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_hw_wrapper.tcl -notrace
